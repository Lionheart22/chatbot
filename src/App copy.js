function initCognitoSDK() {
  AWS.config.region = 'eu-west-1'; // like: us-east-1
  var authData = {
    ClientId: '1t03vhoshqhq93tg1p1uccr55', // Your client id here
    AppWebDomain: 'https://iot-demo-nelson.auth.eu-west-1.amazoncognito.com',
